...
foreach(COMPONENT ${CUDD_DEPS})
  ...
  if(CUDD_${COMPONENT}_LIB)
    ...
    list(APPEND CPREL_LIBRARIES ${CUDD_${COMPONENT}_LIB})
  else()
...
if(CUDD_OBJ AND CUDD_OBJ_LIB)
  ...
  list(APPEND CPREL_LIBRARIES ${CUDD_OBJ_LIB})
else()
...
foreach(COMPONENT ${NEEDED_CPREL_LIBS})
  ...
  if(CPREL_${COMPONENT}_LIB)
    list(APPEND CPREL_LIBRARIES ${CPREL_${COMPONENT}_LIB})
...
#message(STATUS "Libraries: ${CPREL_LIBRARIES}")
